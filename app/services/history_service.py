...
def save_history(user_id: int, input_data: dict, result: dict) -> History:
    ...
    record = History(
        ...
        ampere_stabil=_bool(input_data.get("ampere_stabil", "Tidak")),
        tegangan_stabil=_bool(input_data.get("tegangan_stabil", "Tidak")),
        ...
        resistansi_isolasi_normal=_bool(input_data.get("resistansi_isolasi_normal", "Tidak")),
        # Pengukuran
